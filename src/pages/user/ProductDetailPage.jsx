...
const ProductDetailPage = ({ isLoggedIn, userName, addToCart, cartItems }) => {
  ...
  const handleAddToCart = () => {
    ...
    }); // Di sini Anda bisa menambahkan pesan konfirmasi yang lebih baik daripada alert()
    console.log(
        ...
        <div className="grid grid-cols-2 gap-10">
          ...
          <div className="flex gap-4">
            ...
            <div className="w-1/5 flex flex-col gap-2">
                           {" "}
              <img
                src="/src/assets/detail-product-small.png"
                alt="thumbnail 1"
                className="w-full h-auto rounded-lg shadow-md"
              />
                           {" "}
          ...
          <div>
            ...
                       {" "}
            <p className="text-ecotani-green text-3xl font-bold">
            ...
            <div className="bg-gray-100 p-6 mt-6 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-4">
                Atur Jumlah Untuk Melakukan Pesanan
              </h3>
                           {" "}
        ...
        <div className="bg-gray-100 p-6 rounded-lg mt-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-shrink-0">
                           {" "}
              <img
                src="/src/assets/seller-photo.png"
          ...
          <p className="mt-4 text-sm text-gray-700">
            Produsen kompos organik terpercaya dengan pengalaman lebih dari 10
            tahun. Kami berkomitmen menyediakan produk berkualitas tinggi untuk
          ...
          <div className="bg-gray-100 p-6 rounded-lg space-y-4">
            ...
            <div className="flex items-center">
              ...
              <p className="ml-2 text-gray-700 text-sm">
                dari 5.0 ({product.reviews.length} ulasan)
              </p>
                         {" "}
            </div>
                       {" "}
