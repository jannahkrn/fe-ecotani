...
const ProfilePage = ({ cartItems }) => {
  ...
  const [storeData, setStoreData] = useState({
    ...
    storeDescription:
      "Toko online terpercaya menjual gadget, aksesoris teknologi, dan fashion dengan kualitas terbaik. Melayani pengiriman ke seluruh Indonesia.",
  ...
  const handleDeleteStore = () => {
    if (
      window.confirm(
        "Apakah Anda yakin ingin menghapus toko beserta semua produk?"
      )
    ) {
      setHasStore(false);
      setProducts([]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
            ...
            <div className="flex flex-col">
              ...
              <input
                type="text"
                name="paymentMethod"
                value={storeData.paymentMethod}
                onChange={handleInputChange}
                placeholder="Transfer BCA, BRI, OVO, DANA"
                className="p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-ecotani-green"
              />
            </div>
            <div className="flex flex-col">
      ...
      return (
        <div className="bg-white p-6 rounded-lg shadow-md space-y-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Berat minimal limbah yang dapat dijual adalah 100 gram (0,1 kg).
          </p>
          ...
          <div className="bg-gray-100 p-8 rounded-lg text-center border-2 border-dashed border-gray-300 relative">
              ...
              <div className="flex justify-center items-center">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M4 16l4.586-4.586a2 2 0 012.828 0L15 16m-2-4l4.586-4.586a2 2 0 012.828 0L20 12m-6 4h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
                  />
                </svg>
              </div>
            )}
            ...
            <p className="text-sm text-gray-500">
              Klik tombol di bawah untuk upload foto limbah transfer
            </p>
            <input
              type="file"
              id="imageUpload"
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-sm text-ecotani-green">
            ...
            {addresses.map((addr) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-ecotani-green text-sm font-semibold hover:underline"
                >
                  Ubah Alamat
                </button>
              </div>
          ...
          <div className="space-y-4">
            ...
            {purchaseHistory.map((order) => {
                  ...
                  case "completed":
                    return (
                      <div className="flex justify-end gap-2 mt-2">
                        <Link
                          to="/review"
                          className="bg-[#43703A] text-white font-bold py-1 px-5 rounded shadow-lg hover:bg-[#345a2e] transition-colors"
                        >
                          Rating Sekarang
                        </Link>
                      </div>
              ...
              return (
                <div
                  key={order.id}
                  className="bg-white p-6 rounded-lg shadow-md flex justify-between items-center mb-4"
                >
