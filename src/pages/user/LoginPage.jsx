  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white font-sans p-4 md:p-10">
      <div className="flex flex-col items-center justify-center w-full max-w-2xl">
        ...
        {/* Container untuk teks dan form agar sejajar */}
        <div className="w-full">
            {/* Teks Pengantar yang dipindahkan dan rata kiri */}
            <div className="text-left mb-8">
                <h1 className="text-4xl font-bold text-gray-800 mb-2">Selamat Datang Kembali!</h1>
                <p className="text-gray-600 text-lg">Masuk ke akun Anda dan lanjutkan kontribusi untuk lingkungan yang lebih bersih dan berkelanjutan.</p>
            </div>
            
            <div className="bg-white p-10 rounded-xl border border-gray-300 w-full">
