      ...
      <div className="container mx-auto">
        <div className="flex justify-between flex-wrap pb-8 mb-4">
          ...
          <div className="flex-1 min-w-[150px] mr-5 mb-5">
            ...
            <ul className="list-none p-0 m-0 text-sm">
              <li className="mb-2"><span className="text-gray-700">Jual Limbah</span></li>
              <li className="mb-2"><span className="text-gray-700">Beli Bahan Daur Ulang</span></li>
              <li className="mb-2"><span className="text-gray-700">Konsultasi Lingkungan</span></li>
              <li className="mb-2"><span className="text-gray-700">Edukasi Lingkungan</span></li>
            </ul>
          </div>
